package com.gxg.scrolltablayout.scrollandtablayout.widght.headvp;
    ...
    private boolean isRecyclerViewTop(RecyclerView recyclerView) {
        if (recyclerView != null) {
            ...
            if (layoutManager instanceof LinearLayoutManager) {
                ...
                if (childAt == null || (firstVisibleItemPosition == 0 && ScreenSizeUtil.Px2Dp(childAt.getTop()) == 10)|| (firstVisibleItemPosition == 0 && childAt.getTop() == 0)) {
                    return true;
                }
